...
pins = [24,12,19,21,23,22,15,11,26,18,16,13]  
...
def digitalWriteByte(val):  
	GPIO.output(24, val & (0x01 << 0))  
	GPIO.output(12, val & (0x01 << 1))  
	GPIO.output(19, val & (0x01 << 2))  
	GPIO.output(21, val & (0x01 << 3))  
	GPIO.output(23, val & (0x01 << 4))  
	GPIO.output(22, val & (0x01 << 5))  
	GPIO.output(15, val & (0x01 << 6))  
	GPIO.output(11, val & (0x01 << 7))  
